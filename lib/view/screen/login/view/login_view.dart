            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    "Sign In for free to search Stocks",
                  ...
                  InkWell(
                    onTap: () {
                      ...
                      ref.read(loginNotifierProvider.notifier).login(loginRequestModel);
                    },
                    child: Container(
                      height: 50,
                      ...
                      child: loginState.isLoading ? const Center(child: SizedBox(height: 30, width: 30, child: CircularProgressIndicator(color: kBlack,))) 
                      : Center(
                        child: Row(
